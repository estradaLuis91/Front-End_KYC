   ...
   <aside :class="`${is_expanded ? 'is-expanded' : ''}`">
    ...
    <h3>Menu</h3>
		<div class="menu">
			...
			<router-link to="/Detail" class="button">
				<span class="material-icons">format_list_numbered_rtl</span>
				<span class="text">Detalle de datos</span>
			</router-link>
			<router-link to="/List" class="button">
				<span class="material-icons">fact_check</span>
				<span class="text">Lista de datos</span>
			</router-link>
		</div>
...
<script setup>
import { ref } from 'vue'
import logoURL from '../assets/k_logo.png'
